...
@include('platform-admin.layouts.menu')
    ...
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Données globales /</span> Toutes les balances des marchands
    </h4>
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <div>
                <h5 class="mb-0">Toutes les balances des marchands</h5>
                <p class="text-muted mb-0">Liste de toutes les balances (toutes entreprises confondues)</p>
            </div>
        ...
        <div class="card-body">
            ...
            <form method="GET" action="{{ route('platform-admin.global-data.balances') }}" class="mb-4">
                <div class="row g-3">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                        <a href="{{ route('platform-admin.global-data.balances') }}" class="btn btn-secondary w-100">Réinitialiser</a>
                    </div>
                </div>
                @if(request('per_page'))
                    ...
                    <tbody class="table-border-bottom-0">
                        @forelse($balances as $balance)
                            <tr>
                                <td>{{ $balance->id }}</td>
                                <td>
                                    <strong>{{ $balance->entreprise->name ?? 'N/A' }}</strong>
                                </td>
                                <td>
                                    <strong>
                        ...
                        @empty
                            <tr>
                                <td colspan="8" class="text-center">Aucune balance trouvée</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
