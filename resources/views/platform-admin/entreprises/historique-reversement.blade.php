...
@include('platform-admin.layouts.menu')
    ...
    <h4 class="fw-bold py-3 mb-4">
        ...
        </span> Historique de reversement
    </h4>
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <div>
                <h5 class="mb-0">Historique de reversement</h5>
        ...
        <div class="card-body">
            ...
            <form method="GET" action="{{ route('platform-admin.entreprises.historique-reversement', ['id' => $entreprise->id]) }}" class="mb-4">
                <div class="row g-3">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                        <a href="{{ route('platform-admin.entreprises.historique-reversement', ['id' => $entreprise->id]) }}" class="btn btn-secondary w-100">Réinitialiser</a>
                    </div>
                </div>
                @if(request('per_page'))
            ...
            <div class="table-responsive text-nowrap">
                <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                        ...
                        @empty
                            <tr>
                                <td colspan="11" class="text-center">Aucun reversement trouvé pour cette entreprise</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
