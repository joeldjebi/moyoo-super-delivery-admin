...
@include('platform-admin.layouts.menu')
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Historique des ramassages</h5>
        ...
        <div class="card-body">
            <!-- Filtres -->
            <form method="GET" action="{{ route('platform-admin.entreprises.ramassages', $entreprise->id) }}" class="mb-4">
                <div class="row g-3">
                    <div class="col-md-4">
                        <input type="text" name="search" class="form-control" placeholder="Rechercher (code, contact, adresse, boutique, marchand)" value="{{ request('search') }}">
                    </div>
                    <div class="col-md-2">
                    ...
                    <div class="col-md-3">
                        <div class="d-flex justify-content-end">
                            ...
                            <a href="{{ route('platform-admin.entreprises.ramassages', $entreprise->id) }}" class="btn btn-secondary">
                    ...
                    <tbody class="table-border-bottom-0">
                        @forelse($ramassages as $ramassage)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('platform-admin.entreprises.ramassage.show', [$entreprise->id, $ramassage->id]) }}" class="btn btn-sm btn-primary">
                        ...
                        @empty
                            <tr>
                                <td colspan="12" class="text-center">Aucun ramassage trouvé</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
