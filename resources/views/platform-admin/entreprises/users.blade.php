...
@include('platform-admin.layouts.menu')
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <div>
                <h5 class="mb-0">Utilisateurs de l'entreprise</h5>
        ...
        <div class="card-body">
            ...
            <form method="GET" action="{{ route('platform-admin.entreprises.users', ['id' => $entreprise->id]) }}" class="mb-4">
                <div class="row g-3">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-2">
                        <select name="user_type" class="form-select">
                            ...
                            <option value="entreprise_admin" {{ request('user_type') == 'entreprise_admin' ? 'selected' : '' }}>Admin Entreprise</option>
                    ...
                    <div class="col-md-2">
                        <a href="{{ route('platform-admin.entreprises.users', ['id' => $entreprise->id]) }}" class="btn btn-secondary w-100">Réinitialiser</a>
                    </div>
                </div>
                @if(request('per_page'))
            ...
            <div class="table-responsive text-nowrap">
                <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                        ...
                        @empty
                            <tr>
                                <td colspan="9" class="text-center">Aucun utilisateur trouvé pour cette entreprise</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
